...
import PetaniTable from '@/Components/Admin/PetaniTable.vue';
import { ref } from 'vue';
...
const messageError = data.session.statuserror
const role = "petani"
let searchs = ref('')


const search = () => {
    const url = route('petanipage.view', { search: searchs.value });
  router.visit(url);
};
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                            <i class="fa-solid fa-plus"></i> Tambah Petani
                        </button>
                        </Link>
